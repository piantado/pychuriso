...
if __name__ == "__main__":
    ...
    generalizations = [ ['a', 'a'], ['a', 'b'], ['a','c'],['a','d'], ['b', 'a'], ['b', 'b'], ['b','c'], ['b','d'],['c', 'a'], ['c', 'b'], ['c','c'],['c','d'],['d','a'],['d','b'],['d','c'],]
    ...
    for c in combos:
        ...
        for condition in [0,1,2,3,4]:
            ...
            load_source("Inputs/Exp2/condition%s.txt" % condition, symbolTable, uniques, facts, shows, basis)  # modifies the arguments
